...
const baseParameterDefs: Partial<Record<ParameterKey, ParameterDefInput>> = {
  ...
  overtonesCount: {
    ...
    label: "Count",
    description: "Stacks this many harmonics above what is already there.",
    default: 32,
    min: 1,
    max: 64,
    step: 1,
  ...
  overtonesScale: {
    ...
    name: "Vertical Scale",
    label: "Scale",
    description: "Spaces the overtones wider or narrower apart, detuning them off the natural harmonic series.",
    default: 1,
    min: -4,
    max: 4,
    step: 0.01,
  ...
  overtonesDecay: {
    ...
    name: "Decay",
    label: "Decay",
    description: "Fades the higher overtones off, from a full bright stack down to just the first one or two.",
    default: 0.0,
    min: 0,
    max: 100,
    step: 0.1,
  ...
  overtonesShape: {
    ...
    label: "Shape",
    description: "Spaces the overtones by the harmonic series, by octaves, or by the selected scale.",
    default: "logarithmic",
