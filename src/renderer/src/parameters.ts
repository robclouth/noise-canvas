...
const baseParameterDefs: Partial<Record<ParameterKey, ParameterDefInput>> = {
  ...
  cloneSpaceBeats: {
    ...
    label: "Gap ↔",
    description: "Sets the time between copies, in beats. This is the echo time.",
    default: 0.25,
    min: -32,
    max: 32,
    step: 0.001,
  ...
  cloneSpaceSemis: {
    ...
    label: "Gap ↕",
    description: "Sets the pitch step between copies, in semitones. 7 gives fifths, 12 gives octaves.",
    default: 0,
    min: -96,
    max: 96,
    step: 0.01,
  ...
  cloneCountX: {
    ...
    label: "Copies ↔",
    description: "Repeats the sound this many times along time. 0 adds nothing.",
    default: 3,
    min: 0,
    max: 63,
    step: 1,
  ...
  cloneCountY: {
    ...
    label: "Copies ↕",
    description: "Repeats the sound this many times up or down the pitch axis. 0 adds nothing.",
    default: 0,
    min: 0,
    max: 63,
    step: 1,
  ...
  attractMap: {
    ...
    label: "Map",
    description:
      "Picks the landscape energy is drawn toward — the source's own loud content, the notes of the scale, the snap grid, or a modulator's pattern.",
    default: 0,
    options: [
  ...
  attractSourceFile: {
    ...
    label: "Source",
    description:
      "Picks the sound whose loud regions form the Source map's landscape. Leave it empty and the sound attracts toward itself.",
    default: null,
    includeInStep: true,
    effectType: "attract",
    pickMode: "modal",
  ...
  attractAmountX: {
    ...
    name: "Pull Time",
    label: "Pull ↔",
    description: "Sets how far energy moves in time toward the map. Negative pushes away; past 100 overshoots.",
    default: 0,
    min: -100,
    max: 200,
    step: 1,
  ...
  attractAmountY: {
    ...
    name: "Pull Pitch",
    label: "Pull ↕",
    description: "Sets how far energy moves in pitch toward the map. Negative pushes away; past 100 overshoots.",
    default: 100,
    min: -100,
    max: 200,
    step: 1,
  ...
  attractSmoothX: {
    ...
    name: "Smooth Time",
    label: "Smooth ↔",
    description: "Widens the map's valleys along time, in beats — wider valleys reach further and pull more gently.",
    default: 0.25,
    min: 0.01,
    max: 4,
    step: 0.01,
  ...
  attractSmoothY: {
    ...
    label: "Smooth ↕",
    description:
      "Widens the map's valleys across pitch, in semitones — wider valleys reach further and pull more gently.",
    default: 1,
    min: 0.1,
    max: 24,
    step: 0.1,
