...
const baseParameterDefs: Partial<Record<ParameterKey, ParameterDefInput>> = {
  ...
  attractMap: {
    ...
    label: "Map",
    description:
      "Picks the landscape energy is drawn toward — the source's own loud content, the notes of the scale, or the snap grid.",
    default: 0,
    options: [
  ...
  attractKernel: {
    ...
    name: "Attract Valley",
    label: "Valley",
    description: "Sets the valley's cross-section — how the pull ramps up as energy approaches its target.",
    default: 0,
    options: [
