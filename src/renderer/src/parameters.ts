...
const baseParameterDefs: Partial<Record<ParameterKey, ParameterDefInput>> = {
  ...
  coherenceAmount: {
    kind: "number",
    name: "Coherence Amount",
    label: "Amount",
    description: "Mix between the original phase and the rebuilt coherent phase.",
    default: 100,
    min: 0,
    max: 100,
    step: 1,
    ...
    includeInStep: true,
    modulatable: true,
    effectType: "coherence",
  },
  coherenceSharpness: {
    kind: "number",
    name: "Coherence Sharpness",
    label: "Sharpness",
    description: "Strength of the magnitude-gradient response. Higher values track finer frequency detail into chirps.",
    default: 50,
    min: 1,
    max: 100,
    step: 1,
  ...
  coherenceStrictness: {
    ...
    label: "Strictness",
    description:
      "How selectively the phase rebuild applies. High: only clean tonal ridges are re-phased (repair). Low: everything is pulled onto its local ridge, tonalizing painted textures and noise (sculpt).",
    default: 40,
    min: 0,
    max: 100,
    step: 1,
  ...
  coherenceAttack: {
    kind: "number",
    name: "Coherence Attack",
    label: "Attack",
    description:
      "Aligns phase to sharp magnitude rises so painted edges resynthesize as real onsets instead of fading in as wash.",
    default: 60,
    min: 0,
    max: 100,
    step: 1,
