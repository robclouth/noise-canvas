...
vec4 applyEffectStroke(vec4 sourceTexel, ProcessingUvs coords, float audioLevelDb) {
    float scale = applyModulation(overtonesScale.value, overtonesScale.minValue, overtonesScale.maxValue, overtonesScale.modulationAmounts, overtonesScale.contextualModAmounts, overtonesScale.macroAmounts, coords.dest, 0, audioLevelDb);
    float decay = applyModulation(overtonesDecay.value, overtonesDecay.minValue, overtonesDecay.maxValue, overtonesDecay.modulationAmounts, overtonesDecay.contextualModAmounts, overtonesDecay.macroAmounts, coords.dest, 0, audioLevelDb);
